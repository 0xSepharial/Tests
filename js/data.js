...
export class DataEngine {
  ...
  // price simulation
  _generate() {
    const COUNT    = 520;  // ~8.6 hours of 1m data — feels right for the default view
    ...
    for (let i = 0; i < COUNT; i++) {
      ...
      // GARCH(1,1) vol update — probably overkill but the vol clustering looks way more realistic
  ...
  // simple seeded prng — same seed always gives the same footprint layout per candle
  _seededRand(seed) {
